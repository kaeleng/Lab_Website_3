...
app.get('/player_info', function(req, res) {
 var football_players = "SELECT name,id FROM football_players;";
 db.any(football_players).then(function (rows) {
...
app.get('/player_info/select_player', function(req,res) {
  ...
  db.any(player_info).then(function(rows){ 
    res.render('pages/player_info',{
      my_title: "Player Information",
      data:rows,
      id:player_id,
...
//   var player_info = "select * from football_players where id ='" + player_choice + "';";
//   var player_id = "SELECT id FROM football_players;";
//   var games_played = "SELECT COUNT(*) FROM football_games WHERE'" + player_choice + " =ANY(players);";
  
//   db.task('get-everything', task => {
//     return task.batch([task.any(player_info), task.any(player_id), task.any(games_played)]);
//   })
//   .then(info => {
//     res.render('pages/player_info',{
